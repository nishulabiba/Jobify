...
const Header = () => {
    return (
        <div className='flex flex-row justify-around mt-0  ps-8 bg-gray-100 p-5  '>
            <div className="ms-8  mt-20 text-left w-1/3">
                <h1 className='text-5xl  font-bold text-black'>One Step Closer To Your </h1>
            ...
            <img className='bg-fixed bg-contain bg-left w-1/2 mb-8 ' src="./m.png" alt="" />
        </div>
    );
};
